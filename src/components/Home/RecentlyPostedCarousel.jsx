...
function RecentlyPostedCarousel() {
  ...
  return (
    <div className="ot-5 flex flex-col items-center space-y-5">
      <div data-aos="fade-left" data-aos-duration="500" className="flex flex-row items-center text-center space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-5">
        <h1 className="text-xl sm:text-[22px] md:text-2xl lg:text-3xl font-bold">{StatikContent.recently_posted}</h1>
...
export default RecentlyPostedCarousel;